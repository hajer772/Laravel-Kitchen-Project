...
return [
    ...
    "design" => "تصاميم المطبخ",
    "review" => "آراء العملاء",
    "contact-us" => "اتصل بنا",

    "footer-website" => "جميع الحقوق محفوظة للمطبخ ",
    "footer-developer" => "تم التصميم والتطوير بواسطة مجموعة مروان ",

    "about-subtitle" => "مصممي المطابخ",
    "about-title" => "نحن الرائدون في العالم",
    ...
    'quote-paragraph' => "لوريم إيبسوم dolor sit amet",
    'quote-title' => "دعونا نبني مطبخك!",
    'quote-btn' => "يتعلم أكثر",

    'counter-paragraph' => 'لوريم إيبسوم دولور سيت أميت، consectetur adipiscing إيليت. Nunc mauris arcu، lobortis id interdum vitae، interdum eget elit.',

    "contact-detail-title" => "المكتب الرئيسي",
    'contact-detail-paragraph' => "هناك العديد من الاختلافات المتاحة لنصوص لوريم إيبسوم، ولكن الغالبية عانت من .",
    "contact-address" => "123 بارك أفينيو، نيويورك، الولايات المتحدة",
    "contact-form-title" => "دعونا نتواصل",
    "contact-input-name" => "اسمك",
    "contact-input-email" => "بريد إلكتروني",
    "contact-input-subject" => "موضوع",
    "contact-textarea" => "رسالتك",
    "contact-button" => "إرسال رسالة",

    "stand-inner-sec-subtitle" => "أكثر مرونة في صفحة واحدة",
    "stand-inner-sec-title" => "صفحة مستقلة",
    "stand-inner-sec-paragraph" => "Curabitur mollis bibendum luctus. Duis Suscipit Dui Sed Suscipit. الدهليز مصدر السيرة الذاتية بقطر eleifend، في الحد الأقصى من الطلب. السيرة الذاتية Quisque Sodales lectus. Nam porttitor justo sed mi finibus, vel tristique risus faucibus.",


    "portfolio-hover-img-title" => "عرض كبير",
    "portfolio-hover-img-p" => "شاهد أعمالنا المذهلة",
    "portfolio-paragraph" => "Lorem Ipsum هو ببساطة نص شكلي غير حقيقي للطباعة والتنضيد. لقد كان Lorem Ipsum النص الشكلي القياسي في الصناعة. لقد كان Lorem Ipsum النص الشكلي القياسي في الصناعة.",
    "portfolio-subheading" =>'لوريم إيبسوم دولور سيت أميت',
    'portfolio-headingPart1'=>'لقد قمنا',
    'portfolio-heading-greenPart'=>' بتصميم,إنشاء',
    'portfolio-headingPart2'=>'     بعض المطابخ الجميلة ',
    'portfolio-all-options'=>'الجميع',
